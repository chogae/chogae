...
async function 가글버프화면() {
    try {
        ...
        객체생성(가글버프컨테이너, "일번버프리롤", "세로", "가로꽉", "테두리", "여백");
        객체생성(일번버프리롤, "일번버프리롤일행", "", "양쪽", "밑줄");
        객체생성(일번버프리롤일행, "일번버프리롤일행일열", "", "", "여백");
        일번버프리롤일행일열.innerHTML = `오늘의 첫번째 버프`;
        객체생성(일번버프리롤일행, "일번버프리롤일행이열", "버튼", "테두리", "여백");
        일번버프리롤일행이열.innerHTML = `리롤(비용:스태미너1)`;

        일번버프리롤일행이열.onclick = async () => {
            try {
                화면잠금();
        ...
        for (const 종류 in 유저.스탯.오늘의버프[0]) {
            for (const 키 in 유저.스탯.오늘의버프[0][종류]) {
                const 값 = 유저.스탯.오늘의버프[0][종류][키];
                if (값) {
                    결과 = { 종류, 키, 값 };
                    break;
                }
        ...
        객체생성(일번버프리롤, "일번버프리롤이행", "", "양쪽", "");
        객체생성(일번버프리롤이행, "일번버프리롤이행일열", "", "", "여백");
        일번버프리롤이행일열.innerHTML = 버프모음?.[결과?.종류]?.[결과?.키] ?? "???";

        객체생성(일번버프리롤, "일번버프리롤삼행", "", "양쪽", "");
        객체생성(일번버프리롤삼행, "일번버프리롤삼행일열", "", "", "여백");
        일번버프리롤삼행일열.innerHTML = ``;
        객체생성(일번버프리롤삼행, "일번버프리롤삼행이열", "", "", "여백");
        일번버프리롤삼행이열.innerHTML = 결과?.값 ?? "???";
