...
가글미러.innerHTML = `미러전(l)`;
객체생성(가글월드툴팁, "가글서바이벌전", "버튼", `여백`, "");
가글서바이벌전.innerHTML = `서바이벌전`;
...
//화면추가
객체생성(document.body, "삼국맨성장툴팁", "고정", `테두리`, "세로", "숨기기",);
삼국맨성장툴팁.style.zIndex = "9999";
객체생성(삼국맨성장툴팁, "삼국맨장비", "버튼", `여백`, "");
삼국맨장비.innerHTML = `장비(u)`;
객체생성(삼국맨성장툴팁, "삼국맨유물", "버튼", `여백`, "");
삼국맨유물.innerHTML = `유물(p)`;
객체생성(삼국맨성장툴팁, "삼국맨스킬", "버튼", `여백`, "");
삼국맨스킬.innerHTML = `스킬(a)`;
객체생성(삼국맨성장툴팁, "삼국맨영혼", "버튼", `여백`, "");
삼국맨영혼.innerHTML = `영혼(g)`;
객체생성(삼국맨성장툴팁, "삼국맨버프", "버튼", `여백`, "");
삼국맨버프.innerHTML = `버프(h)`;
객체생성(삼국맨성장툴팁, "삼국맨상점", "버튼", `여백`, "");
삼국맨상점.innerHTML = `상점(j)`;
객체생성(삼국맨성장툴팁, "삼국맨전직", "버튼", `여백`, "");
삼국맨전직.innerHTML = `전직(c)`;

객체생성(document.body, "삼국맨월드툴팁", "고정", `테두리`, "세로", "숨기기",);
삼국맨월드툴팁.style.zIndex = "9999";
객체생성(삼국맨월드툴팁, "삼국맨마신전", "버튼", `여백`, "");
삼국맨마신전.innerHTML = `마신전(s)`;
객체생성(삼국맨월드툴팁, "삼국맨미러", "버튼", `여백`, "");
삼국맨미러.innerHTML = `미러전(l)`;
객체생성(삼국맨월드툴팁, "삼국맨서바이벌전", "버튼", `여백`, "");
삼국맨서바이벌전.innerHTML = `서바이벌전`;

객체생성(document.body, "삼국맨정보툴팁", "고정", `테두리`, "세로", "숨기기",);
삼국맨정보툴팁.style.zIndex = "9999";
객체생성(삼국맨정보툴팁, "삼국맨계정삭제", "버튼", `여백`, "");
삼국맨계정삭제.innerHTML = `계정삭제`;
객체생성(삼국맨정보툴팁, "삼국맨로그아웃", "버튼", `여백`, "");
삼국맨로그아웃.innerHTML = `로그아웃(w)`;
객체생성(삼국맨정보툴팁, "삼국맨패치노트", "버튼", `여백`, "");
삼국맨패치노트.innerHTML = `패치노트(e)`;
객체생성(삼국맨정보툴팁, "삼국맨일어난일", "버튼", `여백`, "");
삼국맨일어난일.innerHTML = `일어난일(i)`;
객체생성(삼국맨정보툴팁, "삼국맨커뮤니티", "버튼", `여백`, "");
삼국맨커뮤니티.innerHTML = `커뮤니티(k)`;
객체생성(삼국맨정보툴팁, "삼국맨출석체크", "버튼", `여백`, "");
삼국맨출석체크.innerHTML = `출석체크(z)`;
객체생성(삼국맨정보툴팁, "삼국맨메뉴얼", "버튼", `여백`, "");
삼국맨메뉴얼.innerHTML = `메뉴얼(y)`;
객체생성(삼국맨정보툴팁, "삼국맨우편함", "버튼", `여백`, "");
삼국맨우편함.innerHTML = `우편함(f)`;
객체생성(삼국맨정보툴팁, "삼국맨설정", "버튼", `여백`, "");
삼국맨설정.innerHTML = `설정(t)`;
객체생성(삼국맨정보툴팁, "삼국맨광장", "버튼", `여백`, "");
삼국맨광장.innerHTML = `광장(d)`;
객체생성(삼국맨정보툴팁, "삼국맨칭호", "버튼", `여백`, "");
삼국맨칭호.innerHTML = `칭호(v)`;
객체생성(삼국맨정보툴팁, "삼국맨주인장", "버튼", `여백`, "숨기기");
삼국맨주인장.innerHTML = `주인장(x)`;
        ...
        가글로그인.onclick = async () => {
            try {
                ...
                if (결과.성공) {
                    ...
                    if (현재마신?.스탯.닉네임 === 유저.스탯.닉네임) {
                        게임이름.className = "마법의팔레트마신";

                    } else if (마신방어1위?.스탯.닉네임 === 유저.스탯.닉네임) {
...
async function 가글패치노트화면() {
    try {
        ...
        */
        ...
        <br>
        26.03.24<br>
        모든층에서 몬스터들의 전직 스탯이 1차로 고정됩니다<br>

        <br>
        25.01.21<br>
        재앙에서 조우하는 히든몬스터들의 전투보상에 ×100<br>
        배율이 적용됩니다<br>

        <br>
        25.01.16<br>
        상점에 수제햄버거가 추가되었습니다<br>
        수제햄버거는 오늘 하루만 판매됩니다<br>
        우편함에 모두받기 버튼이 추가되었습니다<br>
        모든화면에서 샐러드나 햄버거 구매 혹은 수령 시<br>
        전투화면의 샐러드와 햄버거 수량에 적용됩니다<br>
        지금부터 스태미너 충전은 전투화면을 이용해주세요<br>

        <br>
        25.01.15<br>
        신규직업 "천인"이 구현되었습니다<br>
        신규직업 "마도사"가 구현되었습니다<br>
        자세한 직업효과는 성장 - 전직 화면을 참고하세요<br>

        <br>
        25.01.14<br>
        속력에 의한 연속공격 랜덤배율 데미지 계산식이<br>
        0.4~0.7 ➡ 0.2~0.5로 변경되었습니다<br>
        속력에 의한 연속공격 횟수가 1~2 ➡ 1~3으로 변경되었습니다<br>
        "영술사"의 직업효과 매커니즘이 변경되었습니다<br>

        <br>
        25.01.13<br>
        6등급 이상 재앙몬스터에게 승리 또는 패배 시<br>
        일어난 일에 기록됩니다<br>
        "영술사"의 직업효과가 구현되었습니다<br>
        속력에 의한 연속공격 랜덤배율 데미지 계산식이<br>
        0.8~1.1 ➡ 0.4~0.7로 변경되었습니다<br>
        밸런스 조사를 위해 슈퍼계정 "gagl"이 전장에 합류합니다<br>

        <br>
        25.01.12<br>
        전당화면 전직표시가 칭호표시로 변경되었습니다<br>
        전직정보는 미니정보창에서 확인 가능합니다<br>
        정보 - 칭호 화면에서 칭호 선택이 가능합니다<br>
        
        <br>
        25.01.09<br>
        영술사 직업의 직업효과가 삭제되었습니다<br>
        주술사의 직업효과가 ×2 ➡ ×5로 변경되었습니다<br>
        도사의 직업효과가 ×2 ➡ ×4로 변경되었습니다<br>
        정보 - 칭호화면이 구현되었습니다<br>
        칭호는 생각날때마다 추가될 예정입니다<br>
        추 후 칭호 선택 시스템 추가하겠습니다<br>
        
        <br>
        25.01.08<br>
        버프화면에서 등장하는 보너스스킬의 리롤범위 최댓값이<br>
        9일 ➡ 2일로 변경되었습니다<br>
        전직화면이 구현되었습니다<br>
        모든 전투로그에 발동스킬의 스킬레벨표시가 추가되었습니다<br>
        마신정보와 미니정보창에 전직표시가 추가되었습니다<br>
        신규직업군. 영술사가 구현되었습니다<br>
        8번스킬. 조준의 효과가 스킬레벨×500 ➡ 스킬레벨×100<br>
        으로 변경되었습니다<br>

        <br>
        25.01.07<br>
        상점 투기 효과가 1~900 ➡ 1~999으로 변경되었습니다<br>
        속력에 의한 연속공격 횟수가 1~4 ➡ 1~2로 변경되었습니다<br>
        버프화면에서 등장하는 보너스스킬의 리롤범위 최댓값이<br>
        9일 ➡ 2일로 변경되었습니다<br>
        ...
        <br>
        25.01.05<br>
        계정삭제 단축키가 삭제되었습니다<br>
        출석체크 화면 구현이 완료되었습니다<br>
        전당 미니정보창 위치를 조정했습니다<br>

        <br>
        25.01.04<br>
        정보 - 출석체크가 구현되었습니다<br>
        출석체크 보상은 우편으로 자동지급됩니다<br>
        화면은 내일 업데이트하겠습니다<br>

        <br>
        25.01.03<br>
        미러전 날짜오류가 수정되었습니다<br>
        마신 마법의팔레트 오류가 수정되었습니다<br>
        미러전 순위에 따른 보상로직이 구현되었습니다<br>
        1위부터 9위까지 30만골드부터 2만골드 차감됩니다<br>

        <br>
        25.01.02<br>
        마신전 마신방어 순위와 별도로, 현재 마신에 등극된 유저에게는<br>
        마신만의 마법의팔레트가 적용됩니다<br>

        <br>
        25.12.31<br>
        오늘의 버프에 ??? 로 표시되던 스킬은 도약이었습니다<br>
        이제 도약 스킬이 정상적으로 표시됩니다<br>
        스킬 프리셋이 구현되었습니다<br>
...
async function 가글전투화면() {
    try {
        ...
        고층 재앙맵에서 패배가 뜬다면, 반자동으로 재앙에서 멈춘 뒤<br>
        저층으로 이동해서 재앙맵을 공략해보세요<br>
        `;

        객체생성(가글전투컨테이너, "가글재화컨테이너", "가로꽉", `테두리`, ``, "세로");
        객체생성(가글재화컨테이너, `재화모음`, ``, ``, ``);
        for (let a = 0; a < 아이템모음.length; a++) {
            객체생성(재화모음, `아이템_${a}`, `여백`, `버튼`, `테두리`);

            window[`아이템_${a}`].onclick = async () => {
                try {
                    화면잠금();

                    if (아이템모음[a] === "샐러드" && !유저.스탯.샐러드) {
                        알림창표시(`샐러드가 없습니다`);
                        return;
                    } else if (아이템모음[a] === "햄버거" && !유저.스탯.햄버거) {
                        알림창표시(`햄버거가 없습니다`);
                        return;
                    } /* else if (아이템모음[a] === "도박" && 유저.스탯.현재골드 < 100000 && 유저.스탯.현재스태미너 > 1820) {
                        알림창표시(`골드가 부족하거나 스태미너가 너무 많습니다`);
                        return;
                    } else if (아이템모음[a] === "투기" && 유저.스탯.현재골드 < 500000 && 유저.스탯.현재스태미너 > 1000) {
                        알림창표시(`골드가 부족하거나 스태미너가 너무 많습니다`);
                        return;
                    } */

                    if (아이템모음[a] === "샐러드" && 유저.스탯.현재스태미너 > 1940) {
                        알림창표시(`아직 배가 부릅니다`);
                        return;
                    } else if (아이템모음[a] === "햄버거" && 유저.스탯.현재스태미너 > 1700) {
                        알림창표시(`아직 배가 부릅니다`);
                        return;
                    }
                    ...
                    const 응답 = await fetch("/rkrmf", {
                        ...
                        body: JSON.stringify({
                            액션: "아이템먹기",
                            액션데이터: { 유저id: 유저.id, 아이템이름: 아이템모음[a] }
                        })
                    });
        ...
        window[`아이템_${0}`].innerHTML = `${아이템모음[0]}(${유저.스탯.샐러드 ?? 0})`;
        window[`아이템_${1}`].innerHTML = `${아이템모음[1]}(${유저.스탯.햄버거 ?? 0})`;
        ...
        악마성.onclick = async () => {
            try {
                ...
                if (결과.성공) {
                    ...
                    몬스터속.innerHTML = `속력 ${숫자한글(결과.몬스터.스탯.최종속력)}`;
...
async function 가글주인장화면() {
    try {
        ...
        for (let i = 0; i < 주인장용.length; i++) {
            if (i % 4 === 0) {
                주인장버튼모음++;
                객체생성(가글주인장컨테이너, `버튼모음${주인장버튼모음}`, "", "", "", "");
            }


            객체생성(window[`버튼모음${주인장버튼모음}`], `주인장용${i}`, `테두리`, "버튼", `여백`);
...
async function 가글메뉴얼화면() {
    try {
        ...
        <br>
        악마성 전투중 1%의 확률로 '재앙'맵이 등장합니다<br>
        ...
        (속력 × 1)%의 확률로 1~3회의 랜덤한 연속공격을합니다<br>
        <br>
        ...
        try {
            ...
            if (결과.성공) {
                ...
                for (const i in 결과.가글전당) {
                    ...
                    let 직업표시 = "";
                    객체생성(window[`${i}전당정보`], `${i}전당전직`, "버튼", "플렉스일", `여백`);
                    if (Array.isArray(결과.가글전당[i].스탯.전직)) {
                        const 전직번호 = 결과.가글전당[i].스탯.전직.findIndex(v => v > 0);
                        if (전직번호 === -1) {
                            window[`${i}전당전직`].innerHTML = `-`;
                        } else {
                            // window[`${i}전당전직`].innerHTML = `${전직이름[전직번호][0]}${결과.가글전당[i].스탯.전직[전직번호]}차"${전직이름[전직번호][결과.가글전당[i].스탯.전직[전직번호]]}"`;
                            window[`${i}전당전직`].innerHTML = `${전직이름[전직번호][결과.가글전당[i].스탯.전직[전직번호]]}`;
                            직업표시 = `"${전직이름[전직번호][결과.가글전당[i].스탯.전직[전직번호]]}"`;
                        }
                    } else {
                        window[`${i}전당전직`].innerHTML = `-`;
                    ...
                    // 객체생성(window[`${i}전당정보`], `${i}전당칭호`, "버튼", "플렉스일", `여백`);
                    // if (Array.isArray(결과.가글전당[i].스탯.선택된칭호)) {
                    //     const 칭호번호 = 결과.가글전당[i].스탯.선택된칭호.findIndex(v => v > 0);
                    //     if (칭호번호 === -1) {
                    //         window[`${i}전당칭호`].innerHTML = `-`;
                    //     } else {
                    //         window[`${i}전당칭호`].innerHTML = `${칭호모음[칭호번호][0]}`;
                    //     }
                    // } else {
                    //     window[`${i}전당칭호`].innerHTML = `-`;
                    ...
                    window[`${i}전당순위`].style.flex = `3`;
                    window[`${i}전당전투력`].style.flex = `7`;
                    window[`${i}전당전직`].style.flex = `6`;
                    window[`${i}전당닉넴`].style.flex = `6`;

                    if (결과.가글전당[i].스탯.닉네임 === 현재마신?.스탯.닉네임) {
                        window[`${i}전당닉넴`].className = `마법의팔레트마신`;

                    } else if (결과.가글전당[i].스탯.닉네임 === 마신방어1위?.스탯.닉네임) {
                    ...
                    window[`${i}전당정보`].onclick = async (e) => {
                        ...
                        try {
                            ...
                            객체생성(미니일행, `미니닉넴`, ``, ``, `여백`);
                            if (Array.isArray(유저들.선택된칭호)) {
                                const 칭호번호 = 유저들.선택된칭호.findIndex(v => v > 0);
                                if (칭호번호 === -1) {
                                    미니닉넴.innerHTML = `${유저들.닉네임}`;
                                } else {
                                    미니닉넴.innerHTML = `"${칭호모음[칭호번호][0]}" ${유저들.닉네임}`;
                                }
                            } else {
                                미니닉넴.innerHTML = `${유저들.닉네임}`;
                            ...
                            if (유저.스탯.주인장) {
                                객체생성(미니사행좌, `미니퇴장일`, ``, ``, `양쪽`);
                                객체생성(미니퇴장일, `미니퇴장일좌`, ``, ``, `여백`);
                                미니퇴장일좌.innerHTML = `퇴장`;
                                객체생성(미니퇴장일, `미니퇴장일우`, ``, ``, `여백`);
                                미니퇴장일우.innerHTML = `${유저들.접속년}`;

                                객체생성(미니사행좌, `미니최고층일`, ``, ``, `양쪽`);
                                객체생성(미니최고층일, `미니최고층일좌`, ``, ``, `여백`);
                                미니최고층일좌.innerHTML = `최고층`;
                                객체생성(미니최고층일, `미니최고층일우`, ``, ``, `여백`);
                                미니최고층일우.innerHTML = `${유저들.최고층}`;
                            }
                            ...
                            객체생성(미니사행우, `미니오른둘`, `여백`, `세로`, `가로꽉`);
                            미니오른둘.style.padding = `0px 5px`;
                            객체생성(미니오른둘, `미니오른둘좌`, ``, `왼쪽`, `여백`);
                            미니오른둘좌.innerHTML = `전적`;
                            미니오른둘좌.style.padding = `0px 5px`;
                            객체생성(미니오른둘, `미니오른둘우2`, ``, `오른쪽`, `여백`);
                            미니오른둘우2.innerHTML = `${숫자한글(유저들.악마승리) ?? `-`}승/${숫자한글(유저들.악마패배) ?? `-`}패`;
                            미니오른둘우2.style.padding = `0px 5px`;
...
async function 가글유물화면() {
    try {
        ...
        //         객체생성(window[`${i}유물모음`], `${i}유물첫줄`, "양쪽", "밑줄", "");
        //         객체생성(window[`${i}유물첫줄`], `${i}유물이름`, "", "", `여백`);
        //         console.log(Object.values(모든유물[i]).reduce((합, a) => 합 + a, 0));
        //         window[`${i}유물이름`].innerHTML = `[${등급[i].이름}] ${유물모음[i].이름} × ${Object.values(모든유물[i]).reduce((합, a) => 합 + a, 0)}`;
        //         window[`${i}유물이름`].style.color = 색상맵[등급[i].색상];
...
async function 가글스킬화면() {
    try {
        ...
        객체생성(가글스킬컨테이너, `스킬프리셋박스`, "밑줄", "오른쪽", "가로꽉", "");
        for (let i = 0; i < 3; i++) {
            객체생성(스킬프리셋박스, `스킬프리셋박스${i}`, "", "버튼", `테두리`, `여백`);
            window[`스킬프리셋박스${i}`].innerHTML = `프리셋${i + 1}`;
            if (유저.스탯.프리셋 === i) {
                window[`스킬프리셋박스${i}`].style.border = `1px solid ${색상맵[`중파`]}`;

            }


            window[`스킬프리셋박스${i}`].onclick = async () => {
                if (유저.스탯.프리셋 === i) {
                    알림창표시(`현재 선택된 프리셋입니다`);
                    return;
                }
        ...
        for (const i in 스킬모음) {
            ...
            // 객체생성(window[`${i}스킬박스`], `${i}스킬모음1`, "", "", ``, `가로꽉`);
            // 객체생성(window[`${i}스킬박스`], `${i}스킬모음2`, "", "", `밑줄`, `가로꽉`);
            ...
            //     객체생성(부모, `${i}스킬레벨_${a}`, "테두리", "버튼", `여백`, ``);
            //     window[`${i}스킬레벨_${a}`].innerHTML = a;

            //     window[`${i}스킬레벨_${a}`].onclick = async () => {
...
async function 가글마신전화면() {
    try {
        ...
        숭배는 효과적용 계획이 없습니다. 인기도 정도로 생각해주세요<br>
        ...
        try {
            ...
            if (결과.성공) {
                ...
                const 직업인덱스 = 마신.전직.findIndex(v => v > 0);
                let 직업표시 = "-";
                if (직업인덱스 !== -1) {
                    직업표시 = 전직이름[직업인덱스][마신.전직[직업인덱스]];
                }
                const 스탯모음 = {
        ...
        try {
            ...
            if (결과.성공) {
                ...
                for (const i in 모든수다) {
                    ...
                    if (유저.스탯.주인장) {
                        객체생성(window[`광장${광장id}이름시간`], `광장${광장id}삭제`, "버튼", "테두리", `여백`);
                        window[`광장${광장id}삭제`].innerHTML =
                            `삭제`;

                        window[`광장${광장id}삭제`].onclick = async () => {
                            try {
                                화면잠금();
                    ...
                    if (현재마신?.스탯.닉네임 === 항목.스탯.닉넴) {
                        window[`광장${광장id}이름`].className = `마법의팔레트마신`;

                    } else if (마신방어1위?.스탯.닉네임 === 항목.스탯.닉넴) {
                    ...
                    if (항목.스탯.닉넴 === "gagl" || 항목.스탯.닉넴 === "나주인장아니다") {
    ...
    try {
        ...
        for (const a in 유저.스탯.영혼) {
            if (유저.스탯.영혼[a]) {
                ...
                window[`영혼효과${a}`].innerHTML = `${+a + 1}층 악마들의 최종스탯 ×${(1 - 유저.스탯.영혼[a] * 0.001).toFixed(3)}`;
...
async function 가글상점화면() {
    try {
        ...
        // 객체생성(가글상점컨테이너, `상점유료햄버거`, "가로꽉", `테두리`, `여백`, "세로");
        // 객체생성(window[`상점유료햄버거`], `상점유료햄버거1`, "", "", "양쪽", "밑줄");
        // 객체생성(window[`상점유료햄버거1`], `상점유료햄버거11`, "", "", "", `여백`);
        // window[`상점유료햄버거11`].innerHTML = `수제햄버거`;

        // 객체생성(window[`상점유료햄버거1`], `상점유료햄버거12`, "", `테두리`, "버튼", `여백`);
        // window[`상점유료햄버거12`].innerHTML = `₩ 2,000`;

        // window[`상점유료햄버거12`].onclick = () => {
        //     window.open("https://open.kakao.com/o/snVxUjrh", "_blank");
        // };
        // 객체생성(window[`상점유료햄버거`], `상점유료햄버거2`, "", "", "양쪽", "");
        // 객체생성(window[`상점유료햄버거2`], `상점유료햄버거21`, "", "", "", `여백`);
        // 객체생성(window[`상점유료햄버거2`], `상점유료햄버거22`, "", "", "", `여백`);
        // window[`상점유료햄버거22`].innerHTML = `스태미너를 300 회복합니다`;
        ...
        // if (유저.스탯.주인장) {
        //     for (const a in 과금모음) {
        //         객체생성(가글상점컨테이너, `과금${a}`, "가로꽉", `테두리`, `여백`, "세로");
        //         객체생성(window[`과금${a}`], `과금${a}1`, "", "", "양쪽", "밑줄");
        //         객체생성(window[`과금${a}1`], `과금${a}11`, "", "", "", `여백`);
        //         window[`과금${a}11`].innerHTML = `${과금모음[a].이름}`;

        //         객체생성(window[`과금${a}1`], `과금${a}12`, "", `테두리`, "버튼", `여백`);
        //         window[`과금${a}12`].innerHTML = `${과금모음[a].금액}`;

        //         window[`과금${a}12`].onclick = async () => {
        //             try {
        //                 화면잠금();
        ...
        //                     body: JSON.stringify({
        //                         액션: "과금구매",
        //                         액션데이터: { 유저id: 유저.id, 상품코드: 과금모음[a].상품코드 }
        //                     })
        //                 });
        ...
        //         객체생성(window[`과금${a}`], `과금${a}2`, "", "", "양쪽", "");
        //         객체생성(window[`과금${a}2`], `과금${a}21`, "", "", "", `여백`);
        //         객체생성(window[`과금${a}2`], `과금${a}22`, "", "", "", `여백`);
        //         window[`과금${a}22`].innerHTML = `${과금모음[a].설명}`;
        //     }
...
객체생성(document.body, "가글미러전컨테이너", "사백", `테두리`, "세로", "내부", "숨기기");

//가글미러전화면함수
async function 가글미러전화면() {
    try {
        화면잠금(``);
        가글화면전환(가글미러전컨테이너);
        ...
        객체생성(가글미러전컨테이너, "가글미러설명", "가로꽉", "밑줄", `여백`);
        가글미러설명.innerHTML = `
        거울 속 자신과 마주하세요<br>
        미러전에서는 100% 자신과 동일한 적이 등장합니다<br>
        미러전에는 스태미너(1)가 소모됩니다<br>
        매일 1위 30만골드부터 -2만골드씩 9위까지 지급됩니다<br>
        순위 외 참가자들에게는 공통적으로 10만골드가 지급됩니다<br>
        `
        ...
        if (결과.성공) {
            ...
            window.어제유저전체 = 결과.가글전체
                .filter(v => v.스탯.미러전?.[어제()])
                .sort((a, b) => b.스탯.미러전?.[어제()] - a.스탯.미러전?.[어제()]);

            window.오늘유저전체 = 결과.가글전체
                .filter(v => v.스탯.미러전?.[오늘()])
                .sort((a, b) => b.스탯.미러전?.[오늘()] - a.스탯.미러전?.[오늘()]);

            객체생성(가글미러전컨테이너, `순위박스`, "양쪽", "", ``);
            객체생성(순위박스, `어제순위박스`, "세로", "가로꽉", `테두리`, `여백`);
            객체생성(어제순위박스, `어제순위타이틀`, "", "밑줄", ``);
            어제순위타이틀.innerHTML = `어제순위`;
            객체생성(순위박스, `오늘순위박스`, "세로", "가로꽉", `테두리`, `여백`);
            객체생성(오늘순위박스, `오늘순위타이틀`, "", "밑줄", ``);
            오늘순위타이틀.innerHTML = `오늘순위`;
            for (let i = 0; i < 9; i++) {
                객체생성(어제순위박스, `어제${i}1`, "양쪽", "밑줄", `여백`);
                객체생성(window[`어제${i}1`], `어제${i}11`, "", "", ``);
                window[`어제${i}11`].innerHTML = `${i + 1}. [${어제유저전체[i]?.스탯.미러전[어제()] > 0 ? 숫자한글(어제유저전체[i]?.스탯.미러전[어제()]) : `-`}]`;
                객체생성(window[`어제${i}1`], `어제${i}12`, "", "", ``);
                window[`어제${i}12`].innerHTML = `${어제유저전체[i]?.스탯.닉네임 ?? `-`}`;
                if (현재마신?.스탯.닉네임 === 어제유저전체[i]?.스탯.닉네임) {
                    window[`어제${i}12`].className = `마법의팔레트마신`;

                } else if (마신방어1위?.스탯.닉네임 === 어제유저전체[i]?.스탯.닉네임) {
                    window[`어제${i}12`].className = `마법의팔레트1위`;

                } else if (마신방어2위?.스탯.닉네임 === 어제유저전체[i]?.스탯.닉네임) {
                    window[`어제${i}12`].className = `마법의팔레트2위`;

                } else if (마신방어3위?.스탯.닉네임 === 어제유저전체[i]?.스탯.닉네임) {
                    window[`어제${i}12`].className = `마법의팔레트3위`;
                }

                객체생성(오늘순위박스, `오늘${i}1`, "양쪽", "밑줄", `여백`);
                객체생성(window[`오늘${i}1`], `오늘${i}11`, "", "", ``);
                window[`오늘${i}11`].innerHTML = `${i + 1}. [${오늘유저전체[i]?.스탯.미러전[오늘()] > 0 ? 숫자한글(오늘유저전체[i]?.스탯.미러전[오늘()]) : `-`}]`;
                객체생성(window[`오늘${i}1`], `오늘${i}12`, "", "", ``);
                window[`오늘${i}12`].innerHTML = `${오늘유저전체[i]?.스탯.닉네임 ?? `-`}`;
                if (현재마신?.스탯.닉네임 === 오늘유저전체[i]?.스탯.닉네임) {
                    window[`오늘${i}12`].className = `마법의팔레트마신`;

                } else if (마신방어1위?.스탯.닉네임 === 오늘유저전체[i]?.스탯.닉네임) {
                    window[`오늘${i}12`].className = `마법의팔레트1위`;

                } else if (마신방어2위?.스탯.닉네임 === 오늘유저전체[i]?.스탯.닉네임) {
                    window[`오늘${i}12`].className = `마법의팔레트2위`;

                } else if (마신방어3위?.스탯.닉네임 === 오늘유저전체[i]?.스탯.닉네임) {
                    window[`오늘${i}12`].className = `마법의팔레트3위`;
                }
            }

            객체생성(어제순위박스, `어제나1`, "양쪽", "밑줄", `여백`);
            객체생성(window[`어제나1`], `어제나11`, "", "", ``);
            window[`어제나11`].innerHTML = `-. [${유저?.스탯.미러전[어제()] > 0 ? 숫자한글(유저?.스탯.미러전[어제()]) : `-`}]`;
            객체생성(window[`어제나1`], `어제나12`, "", "", ``);
            window[`어제나12`].innerHTML = `${유저?.스탯.닉네임 ?? `-`}`;
            window[`어제나1`].style.border = `1px solid ${색상맵[`중파`]}`;
            if (현재마신?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`어제나12`].className = `마법의팔레트마신`;

            } else if (마신방어1위?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`어제나12`].className = `마법의팔레트1위`;

            } else if (마신방어2위?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`어제나12`].className = `마법의팔레트2위`;

            } else if (마신방어3위?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`어제나12`].className = `마법의팔레트3위`;
            }

            객체생성(오늘순위박스, `오늘나1`, "양쪽", "밑줄", `여백`);
            객체생성(window[`오늘나1`], `오늘나11`, "", "", ``);
            window[`오늘나11`].innerHTML = `-. [${유저?.스탯.미러전[오늘()] > 0 ? 숫자한글(유저?.스탯.미러전[오늘()]) : `-`}]`;
            객체생성(window[`오늘나1`], `오늘나12`, "", "", ``);
            window[`오늘나12`].innerHTML = `${유저?.스탯.닉네임 ?? `-`}`;
            window[`오늘나1`].style.border = `1px solid ${색상맵[`중파`]}`;
            if (현재마신?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`오늘나12`].className = `마법의팔레트마신`;

            } else if (마신방어1위?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`오늘나12`].className = `마법의팔레트1위`;

            } else if (마신방어2위?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`오늘나12`].className = `마법의팔레트2위`;

            } else if (마신방어3위?.스탯.닉네임 === 유저?.스탯.닉네임) {
                window[`오늘나12`].className = `마법의팔레트3위`;
            }



            객체생성(가글미러전컨테이너, `미러박스`, `세로`, `테두리`, `가로꽉`, `여백`);
            객체생성(미러박스, `미러1`, `가로꽉`, `밑줄`, `여백`);
            미러1.innerHTML = `??? (Lv.${유저.스탯.레벨})`;

            객체생성(가글미러전컨테이너, `미러도전`, ``, `테두리`, `버튼`, `여백`);
            미러도전.innerHTML = `도전`;

            객체생성(가글미러전컨테이너, `미러정보`, "", "", "가로꽉", `세로`);
            ...
            미러도전.onclick = async () => {
                try {
                    ...
                    if (결과.성공) {
                        ...
                        객체생성(미러정보, `미러전승패`, "", "", "", `여백`);
                        미러전승패.innerHTML = 결과.전투결과.승패 ? `승리(총데미지:${숫자한글(결과.전투결과.총데미지)})` : `패배(총데미지:${숫자한글(결과.전투결과.총데미지)})`;

                        for (const i in 결과.전투결과.전투로그) {
                            객체생성(미러정보, `${i}미러턴로그`, "세로", "사백", `테두리`, `여백`);
                            객체생성(window[`${i}미러턴로그`], `${i}미러턴`, "", "가로꽉", "밑줄", `여백`);
                            window[`${i}미러턴`].innerHTML = `${i} Turn`;

                            for (const j in 결과.전투결과.전투로그[i]) {
                                if (결과.전투결과.전투로그[i][j].주체) {
                                    객체생성(window[`${i}미러턴로그`], `${i}미러${j} 로그`, "", "가로꽉", "왼쪽", `여백`);
                                    window[`${i}미러${j} 로그`].style.color = 색상맵[`중파`];
                                    ...
                                    window[`${i}미러${j} 로그`].innerHTML =
                                        `${접두어} ${로그.피해.toLocaleString()} `;


                                } else {
                                    객체생성(window[`${i}미러턴로그`], `${i}미러${j} 로그`, "", "가로꽉", "오른쪽", `여백`);
                                    window[`${i}미러${j} 로그`].style.color = 색상맵[`중빨`];
                                ...
                                if (Number(j) === 결과.전투결과.전투로그[i].length - 1) {
                                    객체생성(window[`${i}미러턴로그`], `${i}미러내정보상대정보`, "", "양쪽", "", "");

                                    객체생성(window[`${i}미러내정보상대정보`], `${i}미러내정보`, "플렉스일", `테두리`, "세로", `여백`);
                                    객체생성(window[`${i}미러내정보`], `${i}미러내이름`, "", "", "", `여백`);
                                    window[`${i}미러내이름`].innerHTML = 유저.스탯.닉네임;
                                    객체생성(window[`${i}미러내정보`], `${i}미러내체력`, "", "가로꽉", "", "작게");
                                    window[`${i}미러내체력`].innerHTML = `${숫자로만(결과.전투결과.전투로그[i][j].나남은체력)}/${숫자로만(유저.스탯.최종체력)}`;
                                    window[`${i}미러내체력`].style.backgroundColor = 색상맵[`진빨`];
                                    window[`${i}미러내체력`].style.width = `${100 * 결과.전투결과.전투로그[i][j].나남은체력 / 유저.스탯.최종체력}%`;
                                    window[`${i}미러내정보`].style.border = `1px solid ${색상맵[`진파`]}`;

                                    객체생성(window[`${i}미러내정보상대정보`], `${i}미러상대정보`, "플렉스일", `테두리`, "세로", `여백`);
                                    객체생성(window[`${i}미러상대정보`], `${i}미러상대이름`, "", "", "", `여백`);
                                    window[`${i}미러상대이름`].innerHTML = 결과.미러.스탯.닉네임;
                                    객체생성(window[`${i}미러상대정보`], `${i}미러상대체력`, "", "가로꽉", "", "작게");
                                    window[`${i}미러상대체력`].innerHTML = `${숫자로만(결과.전투결과.전투로그[i][j].상대남은체력)}/${숫자로만(결과.미러.스탯.최종체력)}`;
                                    window[`${i}미러상대체력`].style.backgroundColor = 색상맵[`진빨`];
                                    window[`${i}미러상대체력`].style.width = `${100 * 결과.전투결과.전투로그[i][j].상대남은체력 / 결과.미러.스탯.최종체력}%`;
                                    window[`${i}미러상대정보`].style.border = `1px solid ${색상맵[`중빨`]}`;
...
가글미러.onclick = async () => {
    try {
        if (가글미러전컨테이너.style.display === "none") {
            가글미러전화면();
        }
    } catch (error) {
...
객체생성(document.body, "가글출석체크컨테이너", "사백", `테두리`, "세로", "내부", "숨기기");

//가글출석체크화면함수
async function 가글출석체크화면() {
    try {
        화면잠금(``);
        가글화면전환(가글출석체크컨테이너);

        가글출석체크컨테이너.innerHTML = ``;

        객체생성(가글출석체크컨테이너, "가글출석체크설명", "가로꽉", "밑줄", `여백`);
        가글출석체크설명.innerHTML = `출석체크는 자동입니다<br>
        보상은 매일 접속시 자동으로 우편으로 지급됩니다<br>
        이곳에선 다음 출석보상이 어떤건지 확인하는 용도로 사용하세요<br>
        출석체크 보상 골드는 50000+((회차-1)×10000)입니다<br>
        `;

        const 보상일 = ((유저.스탯.출첵 - 1) % 28) + 1;
        const 달차 = Math.floor((유저.스탯.출첵 - 1) / 28) + 1;
        const 일차 = ((유저.스탯.출첵 - 1) % 28) + 1;

        객체생성(가글출석체크컨테이너, `출석체크박스`, "가로꽉", "세로", ``);
        객체생성(출석체크박스, `출석체크박스회차`, "밑줄", "가로꽉", `여백`);
        출석체크박스회차.innerHTML = `${달차}회차 ${일차}일째`

        for (let 줄 = 0; 줄 < 7; 줄++) {

            객체생성(출석체크박스, `출첵줄${줄}`, "", "양쪽");

            for (let i = 1; i <= 4; i++) {
                const 번호 = 줄 * 4 + i;
                객체생성(window[`출첵줄${줄}`], `출첵줄${줄}${번호}`, "플렉스일", "여백", "테두리", "세로");
                객체생성(window[`출첵줄${줄}${번호}`], `출첵줄${줄}${번호}1`, "", "가로꽉", "밑줄");
                객체생성(window[`출첵줄${줄}${번호}`], `출첵줄${줄}${번호}2`, "", "", "");
                window[`출첵줄${줄}${번호}1`].innerHTML = 번호;
                window[`출첵줄${줄}${번호}2`].innerHTML = `${숫자한글(50000 + ((달차 - 1) * 10000))}Gold`;

                if (번호 <= 일차) {
                    window[`출첵줄${줄}${번호}`].style.border = `1px solid ${색상맵[`중파`]}`;

                }

                if (번호 === 7) {
                    window[`출첵줄${줄}${번호}2`].innerHTML = `신화유물`;
                    window[`출첵줄${줄}${번호}2`].style.color = 색상맵[등급[3].색상];
                } else if (번호 === 14) {
                    window[`출첵줄${줄}${번호}2`].innerHTML = `고대유물`;
                    window[`출첵줄${줄}${번호}2`].style.color = 색상맵[등급[4].색상];
                } else if (번호 === 21) {
                    window[`출첵줄${줄}${번호}2`].innerHTML = `태초유물`;
                    window[`출첵줄${줄}${번호}2`].style.color = 색상맵[등급[5].색상];
                } else if (번호 === 28) {
                    window[`출첵줄${줄}${번호}2`].innerHTML = `타락유물`;
                    window[`출첵줄${줄}${번호}2`].style.color = 색상맵[등급[6].색상];
                }
...
가글출석체크.onclick = async () => {
    try {
        if (가글출석체크컨테이너.style.display === "none") {
            가글출석체크화면();
        }
    } catch (error) {
...
객체생성(document.body, "가글전직컨테이너", "사백", `테두리`, "세로", "내부", "숨기기");

//가글전직화면함수
async function 가글전직화면() {
    try {
        화면잠금(``);
        가글화면전환(가글전직컨테이너);
        ...
        객체생성(가글전직컨테이너, "가글전직설명", "가로꽉", "밑줄", `여백`);
        가글전직설명.innerHTML = `
        직업은 10레벨부터 선택할 수 있습니다<br>
        직업 선택과 변경에는 스태미너(100)가 소모됩니다<br>
        승급은 필요레벨 달성 시 자동으로 이루어집니다<br>
        전직효과에 표시된 (공격)스킬들에는 4번(회복)과 10번(도약)<br>
        스킬을 제외한 나머지 8종의 스킬들이 해당됩니다<br>
        `;

        객체생성(가글전직컨테이너, "가글전직박스", "가로꽉", "세로", ``);
        for (let a = 0; a < 전직이름.length; a++) {
            객체생성(가글전직박스, `전직_${a}`, "가로꽉", "세로", `테두리`, `여백`);

            객체생성(window[`전직_${a}`], `전직_${a}_헤더`, "가로꽉", "밑줄", ``);
            객체생성(window[`전직_${a}_헤더`], `전직_${a}_이름`, "", "여백", ``);
            window[`전직_${a}_이름`].innerHTML = 전직이름[a][0];

            객체생성(window[`전직_${a}_헤더`], `전직_${a}_선택`, "", "여백", `버튼`, `테두리`);
            window[`전직_${a}_선택`].innerHTML = `선택`;

            window[`전직_${a}_선택`].onclick = async () => {
                try {
                    화면잠금();
                    ...
                    if (결과.성공) {
                        ...
                        알림창표시(`직업이 ${전직이름[a][0]}(으)로 변경되었습니다`);
            ...
            for (let b = 1; b < 전직이름[a].length - 4; b++) {
                객체생성(window[`전직_${a}`], `전직_${a}_${b}`, "가로꽉", "세로", `테두리`, `여백`);

                const 직업인덱스 = 유저.스탯.전직.findIndex(v => v > 0);
                if (직업인덱스 === a && 유저.스탯.전직[직업인덱스] === b) {
                    window[`전직_${a}_${b}`].style.border = `1px solid ${색상맵[`중파`]}`;
                }

                객체생성(window[`전직_${a}_${b}`], `전직_${a}_${b}_row1`, "", "양쪽", ``);
                객체생성(window[`전직_${a}_${b}_row1`], `전직_${a}_${b}_row1_name`, "", "", `여백`);
                window[`전직_${a}_${b}_row1_name`].innerHTML =
                    `${전직이름[a][0]} ${b}차 "${전직이름[a][b]}" (Lv.${(b * (b + 1) / 2) * 10} 자동승급)`;

                객체생성(window[`전직_${a}_${b}`], `전직_${a}_${b}_row2`, "", "양쪽", ``);
                객체생성(window[`전직_${a}_${b}_row2`], `전직_${a}_${b}_row2_left`, "", "", ``);
                객체생성(window[`전직_${a}_${b}_row2`], `전직_${a}_${b}_row2_right`, "", "", `여백`);
                window[`전직_${a}_${b}_row2_right`].innerHTML = `${전직효과[a][b]}`;
            }
        }
...
객체생성(document.body, "가글칭호컨테이너", "사백", `테두리`, "세로", "내부", "숨기기");

//가글칭호화면함수
async function 가글칭호화면() {
    try {
        화면잠금(``);
        가글화면전환(가글칭호컨테이너);
        ...
        객체생성(가글칭호컨테이너, "가글칭호설명", "가로꽉", "밑줄", `여백`);
        가글칭호설명.innerHTML = `
        획득된 칭호 선택에는 스태미너(1)가 소모됩니다<br>
        `;

        for (let a = 0; a < 칭호모음.length; a++) {
            객체생성(가글칭호컨테이너, `칭호_${a}`, "가로꽉", "테두리", `여백`, `세로`);
            객체생성(window[`칭호_${a}`], `칭호_${a}_1`, "양쪽", "밑줄", ``, ``);
            객체생성(window[`칭호_${a}_1`], `칭호_${a}_11`, "", "", ``, `여백`);
            if (유저.스탯.선택된칭호[a]) {
                객체생성(window[`칭호_${a}_1`], `칭호_${a}_12`, "", "버튼", `테두리`, `여백`);
                window[`칭호_${a}_12`].innerHTML = `선택됨`;
                window[`칭호_${a}`].style.border = `1px solid ${색상맵[`중파`]}`;

            } else if (유저.스탯.칭호[a]) {
                객체생성(window[`칭호_${a}_1`], `칭호_${a}_12`, "", "버튼", `테두리`, `여백`);
                window[`칭호_${a}_12`].innerHTML = `${유저.스탯.칭호[a] ? `선택` : ``}`;

                window[`칭호_${a}_12`].onclick = async () => {
                    try {
                        화면잠금();
            ...
            window[`칭호_${a}_11`].innerHTML = `${칭호모음[a][0]}` + `${유저.스탯.칭호[a] ? ` (획득)` : ``}`;

            객체생성(window[`칭호_${a}`], `칭호_${a}_2`, "양쪽", "", ``, ``);
            객체생성(window[`칭호_${a}_2`], `칭호_${a}_21`, "", "", ``, `여백`);
            객체생성(window[`칭호_${a}_2`], `칭호_${a}_22`, "", "", ``, `여백`);
            window[`칭호_${a}_22`].innerHTML = `${유저.스탯.칭호[a] ? 칭호모음[a][1] : `???`}`;
...
가글칭호.onclick = async () => {
    try {
        if (가글칭호컨테이너.style.display === "none") {
            가글칭호화면();
        }
    } catch (error) {
...
객체생성(document.body, "가글서바이벌전컨테이너", "사백", `테두리`, "세로", "내부", "숨기기");

//가글서바이벌전화면함수
async function 가글서바이벌전화면() {
    try {
        화면잠금(``);
        가글화면전환(가글서바이벌전컨테이너);

        가글서바이벌전컨테이너.innerHTML = ``;

        객체생성(가글서바이벌전컨테이너, "가글서바이벌전설명", "가로꽉", "밑줄", `여백`);
        가글서바이벌전설명.innerHTML = `
        서바이벌전에 오신걸 환영합니다<br>
        `;

        객체생성(가글서바이벌전컨테이너, "보상표시컨테이너", "가로꽉", "양쪽", ``);
        객체생성(보상표시컨테이너, "섭보상정수", "", "", `여백`);
        let 보상정수 = 0;
        섭보상정수.innerHTML = `종료 시 보상정수 : ${숫자한글(보상정수)}`;

        객체생성(보상표시컨테이너, "섭경과시간", "", "", `여백`);

        객체생성(가글서바이벌전컨테이너, "서바이벌보스컨테이너", "가로꽉", "", `여백`);
        객체생성(서바이벌보스컨테이너, "섭이미지", "", "", `여백`);
        섭이미지.innerHTML = 큰아이콘.서바이벌이미지;

        객체생성(서바이벌보스컨테이너, "섭체력", "", "", `여백`);
        객체생성(섭체력, "섭현재체력", "", "", ``);
        객체생성(섭체력, "섭체력슬러시", "", "", ``);
        객체생성(섭체력, "섭최대체력", "", "", ``);
        객체생성(서바이벌보스컨테이너, "섭체력백분율", "", "", `여백`);
        let 현재체력 = 999999999;
        let 최대체력 = 999999999;

        섭현재체력.innerHTML = 현재체력;
        섭체력슬러시.innerHTML = `/`;
        섭최대체력.innerHTML = 최대체력;

        섭체력백분율.innerHTML = ((현재체력 / 최대체력) * 100).toFixed(0) + `%`;

        객체생성(가글서바이벌전컨테이너, "시작컨테이너", "가로꽉", "", ``);
        객체생성(시작컨테이너, "섭시작", "버튼", "테두리", `여백`);
        섭시작.innerHTML = `시작(스태미너:100)`;


        객체생성(시작컨테이너, "섭종료", "버튼", "테두리", `여백`);
        섭종료.innerHTML = `종료`;
        ...
        섭시작.onclick = () => {
            ...
            타이머인터벌 = setInterval(() => {
                const 경과ms = Date.now() - 시작시간;

                const 전체초 = Math.floor(경과ms / 1000);
                const 분 = Math.floor(전체초 / 60);
                const 초 = 전체초 % 60;

                섭경과시간.innerHTML =
                    `경과시간 : ${분}분 ${String(초).padStart(2, "0")}초`;
            }, 100);
        };

        섭경과시간.innerHTML = `경과시간 : 0분 00초`;
        ...
        //         섭경과시간.innerHTML =
        //             `${분}분 ${String(초).padStart(2, "0")}초 ${String(밀리).padStart(3, "0")}`;
        //     }, 1);
        // };
        // 섭경과시간.innerHTML =
        //     `0분 00초 000`;
...
가글서바이벌전.onclick = async () => {
    try {
        if (가글서바이벌전컨테이너.style.display === "none") {
            가글서바이벌전화면();
        }
    } catch (error) {
...
//시작화면
const 삼국맨화면목록 = [
    // { 이름: "서바이벌전", 실행: 삼국맨서바이벌전화면 },
];

//삼국맨화면전환함수
function 삼국맨화면전환(화면이름) {
    const 화면들 = [
        게임선택컨테이너,
        삼국맨로그인컨테이너,
    ];
...
객체생성(document.body, "삼국맨로그인컨테이너", "사백", `테두리`, "세로", "내부", "숨기기");

//삼국맨로그인화면함수
async function 삼국맨로그인화면() {
    try {
        화면잠금(`삼국맨에 오신걸 환영합니다`);
        삼국맨화면전환(삼국맨로그인컨테이너);

        삼국맨로그인컨테이너.innerHTML = ``;


        객체생성(삼국맨로그인컨테이너, "삼국맨로그인설명", "가로꽉", "밑줄", `여백`, "세로");
        삼국맨로그인설명.innerHTML = `아이디는 한글만 가능합니다`;

        인풋객체생성(삼국맨로그인컨테이너, "삼국맨아이디입력", "", "", `여백`);
        삼국맨아이디입력.type = "text";
        삼국맨아이디입력.placeholder = "아이디 입력";

        인풋객체생성(삼국맨로그인컨테이너, "삼국맨비번입력", "", "", `여백`);
        삼국맨비번입력.type = "password";
        삼국맨비번입력.placeholder = "비번 입력";

        객체생성(삼국맨로그인컨테이너, "삼국맨회원가입", "버튼", `테두리`, `여백`);
        삼국맨회원가입.innerHTML = `회원가입`;
        객체생성(삼국맨로그인컨테이너, "삼국맨로그인", "버튼", `테두리`, `여백`);
        삼국맨로그인.innerHTML = `로그인`;

        삼국맨아이디입력.addEventListener("input", () => {
            if (삼국맨아이디입력.value !==
                삼국맨아이디입력.value
                    .replace(/[^ㄱ-ㅎㅏ-ㅣ가-힣]/g, "")
                    .slice(0, 6)
        ...
        삼국맨비번입력.addEventListener("keydown", async (e) => {
            // 엔터키
            if (e.key === "Enter") {
                삼국맨로그인.click();
            }
        ...
        //삼국맨회원가입함수
        삼국맨회원가입.onclick = async () => {
            try {
                화면잠금(`회원가입중입니다`);

                const id값 = 삼국맨아이디입력.value.trim();
                const pw값 = 삼국맨비번입력.value.trim();
                ...
                const 응답 = await fetch("/tkarnraos", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
                        액션: "삼국맨회원가입",
        ...
        삼국맨로그인.onclick = async () => {
            try {
                ...
                if (결과.성공) {
                    ...
                    유저 = 결과.삼국맨;
                    localStorage.setItem("lastGame", "삼국맨");
                    localStorage.setItem("lastUser", JSON.stringify({ 아이디: id값, 비번: pw값 }));

                    삼국맨화면목록[유저.스탯.화면번호]?.실행() || 삼국맨화면목록[0].실행();

                    삼국맨메뉴들.style.display = `flex`;

                    삼국맨메뉴툴팁(삼국맨정보, 삼국맨정보툴팁);
                    삼국맨메뉴툴팁(삼국맨성장, 삼국맨성장툴팁);
                    삼국맨메뉴툴팁(삼국맨월드, 삼국맨월드툴팁);


                    게임이름.innerHTML = 유저.스탯.닉네임;
                    if (유저.스탯.주인장) {
                        삼국맨주인장.style.display = `flex`;
                    }
                    서브 = 결과.삼국맨서브;
