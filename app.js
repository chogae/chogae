...
객체생성(document.body, "가글패치노트컨테이너", "사백", "테두리", "세로정렬", "내부여백", "숨기기");
...
객체생성(document.body, "가글전투컨테이너", "사백", "", "세로정렬", "숨기기");
...
async function 가글전투화면() {
    try {
        ...
        객체생성(가글전투컨테이너, "가글스태컨테이너", "가로꽉", "테두리", "여백", "세로정렬");
        ...
        객체생성(레벨골드숙련도, "레벨경험치획득경험치", "가로꽉", "세로정렬", "여백", "");
        ...
        객체생성(레벨골드숙련도, "골드현재골드획득골드", "가로꽉", "세로정렬", "여백", "");
        ...
        객체생성(레벨골드숙련도, "숙련도현재숙련도획득숙련도", "가로꽉", "세로정렬", "여백", "");
        ...
        객체생성(가글전투컨테이너, "반자동악마성풀자동", "테두리", "가로꽉", "여백", "세로정렬");
        ...
        악마성.onclick = async () => {
            try {
                ...
                if (결과.성공) {
                    ...
                    객체생성(몬스터정보, "몬스터공방체", "", "가로꽉", "오른쪽", "세로정렬", "");
                    ...
                    for (const i in 결과.전투결과.전투로그) {
                        객체생성(가글전투컨테이너, `${i}턴로그`, "세로정렬", "사백", "테두리", "여백");
                        ...
                        for (const j in 결과.전투결과.전투로그[i]) {
                            ...
                            if (Number(j) === 결과.전투결과.전투로그[i].length - 1) {
                                ...
                                객체생성(window[`${i}내정보상대정보`], `${i}내정보`, "플렉스일", "테두리", "세로정렬", "여백");
                                ...
                                객체생성(window[`${i}내정보상대정보`], `${i}상대정보`, "플렉스일", "테두리", "세로정렬", "여백");
...
객체생성(document.body, "가글설정컨테이너", "사백", "테두리", "세로정렬", "내부여백", "숨기기");
...
async function 가글설정화면() {
    try {
        ...
        객체생성(가글설정컨테이너, "닉네임변경", "테두리", "가로꽉", "여백", "세로정렬");
        ...
        객체생성(가글설정컨테이너, "시작화면변경", "테두리", "가로꽉", "여백", "세로정렬");
...
객체생성(document.body, "가글주인장컨테이너", "사백", "테두리", "세로정렬", "내부여백", "숨기기");
...
객체생성(document.body, "가글장비컨테이너", "사백", "테두리", "세로정렬", "내부여백", "숨기기");
...
async function 가글장비화면() {
    try {
        ...
        객체생성(보유숙보유골, "보유숙필요숙", "세로정렬", "플렉스일", "여백");
        ...
        객체생성(가글장비컨테이너, "무기컨테이너", "가로꽉", "테두리", "세로정렬", "여백");

        객체생성(무기컨테이너, "무기모든기능", "", "가로꽉", "세로정렬");
        ...
        객체생성(가글장비컨테이너, "방어구컨테이너", "가로꽉", "테두리", "세로정렬", "여백");


        객체생성(방어구컨테이너, "방어구모든기능", "", "가로꽉", "세로정렬");
        ...
        객체생성(가글장비컨테이너, "장신구컨테이너", "가로꽉", "테두리", "세로정렬", "여백");

        객체생성(장신구컨테이너, "장신구모든기능", "", "가로꽉", "세로정렬");
        ...
        객체생성(가글장비컨테이너, "날개컨테이너", "가로꽉", "테두리", "세로정렬", "여백");

        객체생성(날개컨테이너, "날개모든기능", "", "가로꽉", "세로정렬");
...
객체생성(document.body, "가글일어난일컨테이너", "사백", "테두리", "세로정렬", "내부여백", "숨기기");
...
객체생성(document.body, "가글전당컨테이너", "사백", "테두리", "세로정렬", "내부여백", "숨기기");
...
// 객체생성(document.body, "가글새로운컨테이너", "사백", "테두리", "세로정렬", "내부여백", "숨기기");
